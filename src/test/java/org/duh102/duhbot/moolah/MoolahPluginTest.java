...
class MoolahPluginTest {
    ...
    public void testBalanceSameUser() throws Exception {
        ...
        try {
            ...
            accountDAO.openAccount(username, bal);
    ...
    public void testMine() throws Exception {
        ...
        try {
            BankAccountDAO accountDAO = new BankAccountDAO(db);
            BankAccount acct = accountDAO.openAccount(username, initialBal);
            MineRecord record = plugin.doMine(event);
            acct = accountDAO.getAccountExcept(acct.uid);
            String response = event.getResponse();
            assertTrue(response.length() > 0);
            assertContains(response, MoolahPlugin.messagePrefix);
    ...
    public void testMineTooSoon() throws Exception {
        ...
        try {
            BankAccountDAO accountDAO = new BankAccountDAO(db);
            BankAccount acct = accountDAO.openAccount(username);
    ...
    public void testOpen() throws Exception {
        ...
        try {
            BankAccountDAO accountDAO = new BankAccountDAO(db);
            plugin.doOpen(event);
            BankAccount acct = accountDAO.getAccountExcept(username);
    ...
    public void testOpenNoPermissions() throws Exception {
        ...
        try {
            ...
            assertThrows(AccountDoesNotExist.class, () -> {
                BankAccountDAO accountDAO = new BankAccountDAO(db);
                accountDAO.getAccountExcept(username);
            });
            String response = event.getResponse();
            assertTrue(response.length() > 0);
            assertContains(response, MoolahPlugin.messagePrefix);
    ...
    public void testTransfer() throws Exception {
        ...
        try {
            BankAccountDAO accountDAO = new BankAccountDAO(db);
            BankAccount source = accountDAO.openAccount(username1, initialBal1);
            BankAccount dest = accountDAO.openAccount(username2, initialBal2);
            plugin.doTransfer(event, arguments);
            source = accountDAO.getAccountExcept(source.uid);
            dest = accountDAO.getAccountExcept(dest.uid);
            String response = event.getResponse();
            assertTrue(response.length() > 0);
            assertContains(response, MoolahPlugin.messagePrefix);
    ...
    public void testTransferSource() throws Exception {
        ...
        try {
            BankAccountDAO accountDAO = new BankAccountDAO(db);
            BankAccount source = accountDAO.openAccount(username2, initialBal2);
            plugin.doTransfer(event, arguments);
            String response = event.getResponse();
            assertTrue(response.length() > 0);
            assertContains(response, MoolahPlugin.messagePrefix);
